...
abstract class GetPopularTvShowsUsecase extends HomeUsecase
...
class GetPopularTvShowsUsecaseImpl extends GetPopularTvShowsUsecase {
  ///
  final HomeRepository repository;

  ///
  GetPopularTvShowsUsecaseImpl({required this.repository});

  @override
  Future<Either<Failures, List<TvEntity>>>? call(Params params) {
    if (params.page != null) {
      return repository.getPopularTvShows(page: params.page!);
    } else {
