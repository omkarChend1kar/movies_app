...
///[Marker Interface] to
abstract class GetCreditsForMovieUsecase extends HomeUsecase
...
class GetCreditsForMovieUsecaseImpl extends GetCreditsForMovieUsecase {
  ///
  final HomeRepository repository;

  ///
  GetCreditsForMovieUsecaseImpl({required this.repository});

  @override
  Future<Either<Failures, List<CreditsEntity>>>? call(Params params) {
    if (params.page != null) {
      return repository.getCreditsForMovie(params.id, page: params.page!);
    } else {
      return repository.getCreditsForMovie(params.id);
    }
  }
}
